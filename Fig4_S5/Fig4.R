...
results = data.frame(tests = c("B vs BP","B vs BM","B vs BR","B vs Be","B vs BE",
"BE vs BER","BE vs BEM","BE vs BEe","BEe vs BEeM"), pvals =
c(t.test(a$B, a$BP, paired=T,alternative='less')$p.value,
t.test(a$B, a$BM, paired=T,alternative='less')$p.value,
t.test(a$B, a$BR, paired=T,alternative='less')$p.value,
t.test(a$B, a$Be, paired=T,alternative='less')$p.value,
t.test(a$B, a$BE, paired=T,alternative='less')$p.value,
t.test(a$BE, a$BER, paired=T,alternative='less')$p.value,
t.test(a$BE, a$BEM, paired=T,alternative='less')$p.value,
t.test(a$BE, a$BEe, paired=T,alternative='less')$p.value,
t.test(a$BEe, a$BEeM, paired=T,alternative='less')$p.value
))
...
pdf("png/violinplots.pdf",width=12,height=4) #Fig4a.pdf
...
topcoefs = unlist(lapply( c(names), function(sample) {
    ...
    cols = c("red", "darkorange", "blue", "purple")[type] # , "purple", "cyan","blue"
    # cols = c("black")

    pdf(paste("png/", sample,"_CV-Lasso-coefficients.pdf",sep=''),width=8,height=8)  #Fig4c.pdf
...
pdf("png/BEeM.Lasso.pdf") #Fig4b.pdf
...
heatmaps=function(x) {
  ...
  colsrow = c("red", "darkorange", "blue", "purple")[typerow] #"darkorange", "red", "purple"
  colscol = c("red", "darkorange", "blue", "purple")[typecol] #"darkorange",
...
pdf("png/Top30Coefs_80Pearson.pdf", width=14,height=7) #Fig4d.pdf

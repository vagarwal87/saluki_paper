...
if(database == "Bb") a=a[,c(1:10,grep("^BIOCHEMICAL",colnames(a)))]
if(database == "BG") a=a[,c(1:10,grep("^GENETIC",colnames(a)))]
if(database == "BGb") a=a[,c(1:10,grep("^BIOCHEMICAL|^GENETIC",colnames(a)))]

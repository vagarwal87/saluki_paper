...
for x in B BC B5 BO B3 BCO B3M BC3M BC3MS BC3MD BC3MSD; do { sbatch --mem 90000 -J $x -o $x.txt --wrap="Rscript lasso_model.R $x"; } done

#after running the same models for mouse
